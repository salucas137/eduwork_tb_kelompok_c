...
?>
          ...
          ?>
					...
					<div class="ceb-item">
						<a href="celebrityes.php?id=<?php echo $data['id']; ?>"><img src="<?php echo $data["foto"]; ?>" alt="" width="270" height="400"></a>
						<div class="ceb-infor">
							<h2><a href="celebrityes.php?id=<?php echo $data['id']; ?>"><?php echo $data['nama_pemain'] ?></a></h2>
