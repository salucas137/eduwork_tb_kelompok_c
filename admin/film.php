    ...
    <section class="section">
        <div class="card">
            ...
            <div class="col-md-10"><br>
                <a href="tambah_film.php" class="btn btn-primary" data-toggle="modal">Tambah Data</a>
            </div>
            </div>
            <div class="card-body">
                <table class="table" id="table1">
                    ...
                    <tr>
                        ...
                        <td><?php echo $data["tahun_rillis"]; ?></td>
                        <td><?php echo $data["rating"]; ?></td>
                        <td><?php echo $data["gambar"]; ?></td>
                        <td>
                            <a href="ubah_film.php?id=<?php echo $data["id"]; ?>" class="btn btn-primary custom"> Edit </a> <br><br>
                            <a href="hapus.php?id=<?php echo $data["id"]; ?>" class="btn btn-danger custom"> Hapus </a>
                        </td>
                    </tr>
            <?php 
                $no++;
