<?php 
  require 'koneksi.php';
  checkLogin();
  $komentar = mysqli_query($koneksi, "SELECT * FROM komentar INNER JOIN film ON komentar.id_film = film.id_film ORDER BY tanggal_komentar DESC");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card-body">
                <table class="table" id="table1">
                    ...
                    <?php foreach ($komentar as $dk): ?>
                        ...
                        <td><?= $dk['tanggal_komentar']; ?></td>
                        <td><?= $dk['judul_komentar']; ?></td>
                        <td><?= $dk['rating_komentar']; ?></td>
                        <td>
                            <a href="hapus_komentar.php?id_komentar=<?= $dk['id_komentar']; ?>" class="btn btn-danger btn-sm btn-hapus" data-nama="Komentar: <?= $dk['nama_komentar']; ?> | <?= $dk['judul_komentar']; ?>"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                        </td>
                        </tr>
                    <?php endforeach ?>
                    </tbody>
