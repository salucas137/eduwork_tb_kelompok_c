<?php 
  require 'koneksi.php';
  checkLogin();
  $genre = mysqli_query($koneksi, "SELECT * FROM kategori");
  ...
  if (isset($_POST['btnTambahGenre'])) {
    if (tambahGenre($_POST) > 0) {
      $nama_kategori = htmlspecialchars(addslashes(ucwords($_POST['nama_kategori'])));
      setAlert("Berhasil ditambahkan", "Genre $nama_kategori berhasil ditambahkan", "success");
      header("Location: kategori.php");
    }
  }
?>
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="index.php"><img src="../admin/assets/images/logo/logo.png" alt="Logo" srcset="" width="130"></a>
            </div>
...
<div class="page-heading">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">DataTable Kategori</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="col-sm text-left">
            <button type="button" data-toggle="modal" data-target="#tambahGenreModal" class="btn btn-primary"><i class="fas fa-fw fa-plus"></i> Tambah Genre</button><br><br>
    <!-- Modal -->
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <div class="form-group">
                        <label for="nama_kategori">Nama Genre</label>
                ...
                <tbody>
                  ...
                  <?php foreach ($genre as $dg): ?>
                    <tr>
                      ...
                      <td>
                        <button class="btn btn-sm btn-success" type="button" data-toggle="modal" data-target="#ubahGenreModal<?= $dg['id_kategori']; ?>"><i class="fas fa-fw fa-edit"></i> Ubah</button>
                        <!-- Modal -->
                        <div class="modal fade" id="ubahGenreModal<?= $dg['id_kategori']; ?>" tabindex="-1" role="dialog" aria-labelledby="ubahGenreModalLabel<?= $dg['id_kategori']; ?>" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <form method="post">
                              <input type="hidden" name="id_kategori" value="<?= $dg['id_kategori']; ?>">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="ubahGenreModalLabel<?= $dg['id_kategori']; ?>">Ubah Genre</h5>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  <div class="form-group">
                                    <label for="nama_kategori<?= $dg['id_kategori']; ?>">Nama Genre</label>
                        ...
                        <a href="hapus_kategori.php?id_kategori=<?= $dg['id_kategori']; ?>" data-nama="Genre Film: <?= $dg['nama_kategori']; ?>" class="btn-hapus btn btn-sm btn-danger"><i class="fas fa-fw fa-trash"></i> Hapus</a>
                      </td>
                    </tr>
                  <?php endforeach ?>
                </tbody>
