            ...
            <div class="card-body">
                <table class="table" id="table1">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="proses_hapus.php?id=<?php echo $data["id"]; ?>" class="btn btn-primary custom"> Edit </a> <br><br>
                            <a href="ubah.php?id=<?php echo $data["id"]; ?>" class="btn btn-danger custom"> Hapus </a>
                        </td>
                    </tr>
            <?php 
                $no++;
